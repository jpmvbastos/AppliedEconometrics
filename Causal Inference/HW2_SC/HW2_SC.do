...
graph export Graph1.png, replace as(png) name("Graph")
...
graph export Graph2.png, replace as(png) name("Graph")
...
graph export Graph3.png, replace as(png) name("Graph")
...
synth_runner cigsale lnincome age15to24 retprice beer(1984(1)1988) ///
		cigsale(1988) cigsale(1980) cigsale(1975), trunit(3) trperiod(1989) nested gen_vars
effect_graphs, trlinediff(-1)
pval_graphs

graph export pvals_std.png, as(png) name("pvals_std")
...
synth_runner cigsale cigsale(1970) cigsale(1971) cigsale(1972) cigsale(1973) cigsale(1974) ///
	  cigsale(1975) cigsale(1976) cigsale(1977) cigsale(1978) cigsale(1979) ///
	  cigsale(1980) cigsale(1981) cigsale(1982) cigsale(1983) cigsale(1984) ///
	  cigsale(1985) cigsale(1986) cigsale(1987) cigsale(1988), trunit(3) trperiod(1989) gen_vars
effect_graphs, trlinediff(-1)
pval_graphs

ereturn list

graph export pvals_std2.png, as(png) name("pvals_std") replace

drop pre_rmspe post_rmspe lead effect cigsale_synth

* To remove post actual treatment years from the plot
drop if year > 1988

synth_runner cigsale cigsale(1970) cigsale(1971) cigsale(1972) cigsale(1973) cigsale(1974) ///
	  cigsale(1975) cigsale(1976) cigsale(1977) cigsale(1978) cigsale(1979) ///
	  cigsale(1980) cigsale(1981), trunit(3) trperiod(1982) gen_vars
effect_graphs, trlinediff(-1)
pval_graphs

graph export pvals_std3.png, as(png) name("pvals_std") replace
