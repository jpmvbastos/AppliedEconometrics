...
cd "/Users/jpmvbastos/Library/CloudStorage/OneDrive-TexasTechUniversity/Personal/Projects/Code/GitHub/AppliedEconometrics/Causal Inference/HW2_SC"
...
graph export "/Users/jpmvbastos/Documents/GitHub/AppliedEconometrics/Causal Inference/Homework/HW2_SC/Graph1.png", /// 
		as(png) name("Graph")
...
graph export "/Users/jpmvbastos/Documents/GitHub/AppliedEconometrics/Causal Inference/Homework/HW2_SC/Graph2.png", /// 
		as(png) name("Graph")
...
synth cigsale cigsale(1970) cigsale(1971) cigsale(1972) cigsale(1973) cigsale(1974) ///
	  ...
	  resultsperiod(1970(1)1988) fig
		
		
graph export "/Users/jpmvbastos/Documents/GitHub/AppliedEconometrics/Causal Inference/Homework/HW2_SC/Graph3.png", /// 
		as(png) name("Graph")
